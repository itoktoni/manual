<x-layout>
    ...
    <x-card title="{{ ucfirst('ruangan') }}">
        <div class="card-table">
            <div class="form-table-container">
                <form id="filter-form" class="form-table-filter" method="GET" action="{{ route(module('getData')) }}">
                    <div class="row">
                        <x-select name="ruangan_code_customer" label="Customer" :model="$model" :options="$customer" />
                    ...
                    <div class="row">
                        ...
                        <x-select name="filter" :options="['' => 'All Filter', 'ruangan_id' => 'Ruangan Id', 'ruangan_code' => 'Ruangan Code']" :value="request('filter')" col="4"/>
                        ...
                        <table class="data-table">
                            <thead>
                                <tr>
                                    ...
                                    <x-th column="ruangan_code_customer" text="Customer"  />
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No ruangan found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
