        ...
        <div class="card-table">
            <div class="form-table-container">
                <form id="filter-form" class="form-table-filter" method="GET" action="{{ route(module('getData')) }}">
                    <div class="row">
                        <x-input :col="3" name="bersih_kotor_tanggal" label="Tanggal Bersih" type="date" placeholder="Search by Tanggal" :value="request('kotor_tanggal')"/>
                        <x-input :col="3" name="bersih_kotor_code" type="text" placeholder="Search by Code" :value="request('kotor_code')"/>
