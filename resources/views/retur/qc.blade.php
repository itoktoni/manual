<x-layout>
    <x-card title="Sorting" :model="$model">
        <x-form :model="$model">
            ...
            <x-select name="rs" readonly value="{{ $model->retur_rs_id ?? null }}" label="Customer" :model="$model" :options="$customer" />
                    ...
                    <tbody id="jenis-tbody">
                        ...
                        <tr>
                            ...
                            <td data-label="Kotor" class="actions">
                                {{ $single->transaksi_qty ?? null }}
                            </td>
                            <td data-label="Qc" class="actions">
